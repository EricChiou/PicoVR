...
public class Pvr_Controller : MonoBehaviour
{
    ...
    void Awake()
    {
        var controller = transform.FindChild("controller").gameObject;
        controller.SetActive(false);
        var dot = transform.FindChild("dot").gameObject;
        dot.SetActive(false);
        var ray_alpha = transform.FindChild("ray_alpha").gameObject;
